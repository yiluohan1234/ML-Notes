...
![](E:\文档\markdown\机器学习\machineLearningInAction\pic\14信噪比.png)
...
$$
A_{m \times n} \approx U_{m \times r} \Sigma_{r x x} V_{r \times n}^{T}
$$


在矩阵的两边同时乘上一个矩阵V，由于V是一个正交的矩阵，所以V转置乘以V得到单位阵I，所以可以化成后面的式子
$$
A_{m \times n} V_{r \times n} \approx U_{m \times r} \Sigma_{r \times r} V_{r \times n}^{T} V_{r \times n} \\A_{m \times n} V_{r \times n} \approx U_{m \times r} \Sigma_{r \times r r}
$$
